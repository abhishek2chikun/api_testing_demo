...
public class OrdersApiTest {
    ...
    public void testPlaceOrderMissingFields() {
        String orderPayload = "{ \"tradingsymbol\": \"INFY\", \"quantity\": 10 }"; // Missing order_type and price
    ...
    public void testAuthenticationRequired() {
        ...
        .then()
            .statusCode(404)
            .body("status", equalTo("error"))
            .body("message", containsString("Not Found")); // Expecting 404 due to missing auth
    }
}
