...
public class OrdersApiTest {
    ...
    public void testPlaceOrderMissingFields() {
        String orderPayload = "{ \"quantity\": 10 }"; // Missing 'tradingsymbol'
    ...
    @Test
    public void testErrorResponseStandard() {
        String orderPayload = "{ \"tradingsymbol\": \"INFY\", \"quantity\": -1 }"; // Invalid quantity
    ...
    public void testAuthenticationAuthorization() {
        // Assuming that the API requires authentication, this test should validate that unauthorized requests are rejected.
        given()
            .queryParam("broker", "upstox")
            .queryParam("user_id", 1)
        .when()
